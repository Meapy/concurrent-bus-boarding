...
- Bus boarding zones are learned from approaching buses and shown as a translucent overlay on the road at the stop. The game options page provides a colour wheel for the global overlay colour. A bus within 40 m of its target waypoint makes its actual current lane authoritative; that physical observation remains cached over inferred route lanes. This keeps paired pull-in stops on their own side while preventing a distant junction or driveway from moving the zone.
