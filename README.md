...
- Updating from a version before 1.5.3 switches the toggle off once, through a hidden `SettingsVersion` field that older settings files do not contain. The player's choice after that is remembered.
